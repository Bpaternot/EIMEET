...
Tournament.create(date: DateTime.new(2017,6,3), number_players: 16, status: "pending", number_consoles: 4, number_games: 4, tournament_type: "medium", bar_id: 13, user_id: 5)
Tournament.create(date: DateTime.new(2017,6,10), number_players: 16, status: "pending", number_consoles: 4, number_games: 4, tournament_type: "medium", bar_id: 7, user_id: 22)
Tournament.create(date: DateTime.new(2017,6,8), number_players: 16, status: "pending", number_consoles: 4, number_games: 4, tournament_type: "medium", bar_id: 18, user_id: 14)
Tournament.create(date: DateTime.new(2017,6,5), number_players: 8, status: "ready", number_consoles: 4, number_games: 4, tournament_type: "small", bar_id: 12, user_id: 4)
...
Player.create(user_id: 1, admin: false, tournament_id: 1, position: "A1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 2, admin: false, tournament_id: 1, position: "A2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 3, admin: false, tournament_id: 1, position: "A3", ps4: false, xbox: false, controller_ps4: 1, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 4, admin: false, tournament_id: 1, position: "A4", ps4: false, xbox: false, controller_ps4: 2, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 5, admin: true, tournament_id: 1, position: "B1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 6, admin: false, tournament_id: 1, position: "B2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 7, admin: false, tournament_id: 1, position: "B3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 8, admin: false, tournament_id: 1, position: "B4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 9, admin: false, tournament_id: 1, position: "C1", ps4: false, xbox: false, controller_ps4: 3, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 10, admin: false, tournament_id: 1, position: "C2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 11, admin: false, tournament_id: 1, position: "C3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 12, admin: false, tournament_id: 1, position: "C4", ps4: false, xbox: false, controller_ps4: 2, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 13, admin: false, tournament_id: 1, position: "D1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 14, admin: false, tournament_id: 1, position: "D2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 15, admin: false, tournament_id: 1, position: "D3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
# #  tournament id=2 : 16 players / status pending
Player.create(user_id: 17, admin: false, tournament_id: 2, position: "A1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 18, admin: false, tournament_id: 2, position: "A2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 19, admin: false, tournament_id: 2, position: "A3", ps4: true, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 20, admin: false, tournament_id: 2, position: "A4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 21, admin: false, tournament_id: 2, position: "B1", ps4: false, xbox: false, controller_ps4: 2, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 22, admin: true, tournament_id: 2, position: "B2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 23, admin: false, tournament_id: 2, position: "B3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 24, admin: false, tournament_id: 2, position: "B4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 25, admin: false, tournament_id: 2, position: "C1", ps4: false, xbox: true, controller_ps4: 2, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 1, admin: false, tournament_id: 2, position: "C2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 2, admin: false, tournament_id: 2, position: "C3", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 2, fifa_game: 0)
Player.create(user_id: 3, admin: false, tournament_id: 2, position: "C4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
# #  tournament id=3 : 16 players / status pending
Player.create(user_id: 8, admin: false, tournament_id: 3, position: "A1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 9, admin: false, tournament_id: 3, position: "A2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 10, admin: false, tournament_id: 3, position: "A3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 11, admin: false, tournament_id: 3, position: "A4", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 2, fifa_game: 0)
Player.create(user_id: 12, admin: false, tournament_id: 3, position: "B1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 13, admin: false, tournament_id: 3, position: "B2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 14, admin: true, tournament_id: 3, position: "B3", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 1, fifa_game: 0)
Player.create(user_id: 15, admin: false, tournament_id: 3, position: "B4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 2, fifa_game: 0)
Player.create(user_id: 16, admin: false, tournament_id: 3, position: "C1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 17, admin: false, tournament_id: 3, position: "C2", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 2, fifa_game: 0)
Player.create(user_id: 18, admin: false, tournament_id: 3, position: "C3", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 19, admin: false, tournament_id: 3, position: "C4", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 2, fifa_game: 0)
Player.create(user_id: 20, admin: false, tournament_id: 3, position: "D1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
# #  tournament id=4 : 8 players / status ready
Player.create(user_id: 21, admin: false, tournament_id: 4, position: "D2", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 22, admin: false, tournament_id: 4, position: "D3", ps4: false, xbox: true, controller_ps4: 0, controller_xbox: 2, fifa_game: 1)
Player.create(user_id: 23, admin: false, tournament_id: 4, position: "D4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 4, admin: true, tournament_id: 4, position: "D1", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 1)
Player.create(user_id: 5, admin: false, tournament_id: 4, position: "D2", ps4: true, xbox: false, controller_ps4: 1, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 6, admin: false, tournament_id: 4, position: "D3", ps4: false, xbox: false, controller_ps4: 1, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 7, admin: false, tournament_id: 4, position: "D4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
Player.create(user_id: 16, admin: false, tournament_id: 4, position: "D4", ps4: false, xbox: false, controller_ps4: 0, controller_xbox: 0, fifa_game: 0)
